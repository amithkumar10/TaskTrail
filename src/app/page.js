        ...
        <div className={`card ${visible ? "visible" : ""}`}>
          ...
          <div className="actions">
            <button className="btn-primary" onClick={() => router.push("/dashboard")}>
              <span className="btn-title">View Dashboard →</span>
              <span className="btn-hint">All intern activity</span>
            </button>
            <button className="btn-secondary" onClick={() => router.push("/personal")}>
              <span className="btn-title">Intern Login ↗</span>
              <span className="btn-hint">My tasks & progress</span>
            </button>
          </div>
